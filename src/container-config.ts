...
// Notre patch fork e8808f2 (MCP distants, un seul type permissif avec `command`
// optionnel) est ABANDONNÉ au profit du modèle upstream, arrivé le 2026-08-11 :
// une union discriminée, plus stricte, avec validation à l'enregistrement.
// Deux conséquences vérifiées avant de basculer :
//  - `headers` disparaît — aucun de nos serveurs n'en portait ;
//  - `type: 'sse'` disparaît — nous n'en avions aucun (`ha` est en 'http').
