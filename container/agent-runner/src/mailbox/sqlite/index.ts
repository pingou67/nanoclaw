...
export class SqliteAgentMailbox implements AgentMailbox {
  ...
  releaseMessages(ids: string[]): void {
    sqliteReleaseMessages(ids);
  }
  ...
  getDeliveredPlatformId(outboundMessageId: string): string | null {
    return sqliteGetDeliveredPlatformId(outboundMessageId);
  }
