...
describe('command classification', () => {
  ...
  // Test d'upstream adapté au fork : `isClearCommand` n'accepte QUE la forme
  // `!clear`. Mattermost intercepte tout `/`-command avant le bot, donc la
  // forme `/clear` n'a jamais été atteignable sur cette installation — la
  // tester ici affirmerait un comportement que le code refuse à dessein. Ce
  // que le scénario vérifie (un écho ne classe pas, une vraie commande du même
  // lot classe) est intact.
